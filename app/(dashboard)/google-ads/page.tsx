 ...
 *
 * The left-nav "Google Ads" link points here (/google-ads). Uses the
 * session-bound Supabase server client so RLS (auth.uid() = user_id) is
 * satisfied — the skeleton at this route was never wired to the DB, which
 * is why it always showed "No plans yet".
 *
 * The wizard itself lives at /google-search/[id] (URL kept for backward
