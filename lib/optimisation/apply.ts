 ...
 * Both counts must be taken over the same set (eligibility-cleared
 * delivering rows, including cooldown). Exactly-all was too late: 3 of 4
 * already removes most of the delivery.
 */
