  ...
  async function addVisibleGroupItems(
    ...
    await persistGroups(
      addVisibleToTikTokGroup(
        ...
        activeGroup.id,
        key,
        stampNewTikTokKeywordChips(activeGroup[key], items),
      ),
    );
  }
    ...
    <div className="space-y-6">
      ...
      {staleTikTokKeywordChips(draft).length > 0 && (
        <p className="rounded-md border border-amber-500/30 bg-amber-500/10 p-3 text-sm text-amber-800 dark:text-amber-200">
          Some keyword interests were saved more than 14 days ago. TikTok
          retires keyword IDs — clear and re-search those chips before launch.
        </p>
      )}
